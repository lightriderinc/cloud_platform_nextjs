export const logtoConfig = {
  managementEndpoint: process.env.LOGTO_MANAGEMENT_ENDPOINT, // Change to your own management endpoint
  endpoint: process.env.LOGTO_ENDPOINT, // Change to your own endpoint
