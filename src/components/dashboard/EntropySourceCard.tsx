...
export default function EntropySourceCard({
  ...
  return (
    ...
    >
      {disabled && (
        <span className="absolute top-2 right-2 text-[10px] font-medium text-gray-600 bg-gray-100 border border-gray-100 px-1.5 py-0.5 default-radius leading-tight">
          Available at Launch
        </span>
      )}
