...
export default function DashboardClassroomLink() {
  ...
  return (
    <>
      <Link href="/classroom" className="flex w-full cursor-pointer group">
        <div className="flex flex-col h-full w-full bg-gray-100 p-5 border border-gray-100 default-radius card-hover-primary gap-3">
          <FaChalkboardTeacher className="text-5xl text-gray-200 group-hover:text-[var(--brand-tertiary)] transition duration-150" />
